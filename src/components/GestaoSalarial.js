...
import {
  ...
  Eye, X, Bus, Building, Coffee, Heart, FileText, Info
} from 'lucide-react';
import api from '../api';
...
const GestaoSalarial = () => {
  ...
  const fetchAllData = async () => {
    ...
    try {
      ...
      setRelatorioDepartamentos(
        Object.entries(deptSalary).map(([depto, total]) => ({ depto, total }))
      );
    } catch (error) {
              ...
              <tbody>
                {filteredFuncionarios.map((f) => (
                  <tr key={f.id}>
                    ...
                    <td>
                      <button className="btn-detalhar" onClick={() => abrirModal(f)}>
            ...
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="modal-body">
                <div className="info-funcionario">
                  ...
                  <div>
                    <strong>Departamento:</strong> {funcionarioSelecionado.departamento || '-'}
                  </div>
                  <div>
                    <strong>Data Admissão:</strong> {formatDate(funcionarioSelecionado.dataAdmissao)}
                  </div>
                </div>
                    ...
                    <div className="composicao">
                      ...
                      <div className="composicao-grid">
                        ...
                        <div className="composicao-linha">
                          <span>
                            <DollarSign size={16} style={{ display: 'inline', marginRight: '4px' }} /> Salário Bruto
                          </span>
                          <span>100%</span>
                        ...
                        <div className="composicao-linha">
                          <span>
                            <Bus size={16} style={{ display: 'inline', marginRight: '4px' }} /> Vale Transporte (VT)
                          </span>
                          <span>10%</span>
                        ...
                        <div className="composicao-linha">
                          <span>
                            <Building size={16} style={{ display: 'inline', marginRight: '4px' }} /> FGTS (8%)
                          </span>
                          <span>8%</span>
                        ...
                        <div className="composicao-linha">
                          <span>
                            <Coffee size={16} style={{ display: 'inline', marginRight: '4px' }} /> Vale Alimentação (VA)
                          </span>
                          <span>10%</span>
                        ...
                        <div className="composicao-linha">
                          <span>
                            <Heart size={16} style={{ display: 'inline', marginRight: '4px' }} /> Plano de Saúde
                          </span>
                          <span>6%</span>
                        ...
                        <div className="composicao-linha">
                          <span>
                            <FileText size={16} style={{ display: 'inline', marginRight: '4px' }} /> INSS
                          </span>
                          <span>7,5%</span>
                        ...
                        <div className="composicao-linha total-encargos">
                          <span>
                            <Info size={16} style={{ display: 'inline', marginRight: '4px' }} /> Total de Encargos
                          </span>
